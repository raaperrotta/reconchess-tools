...
@pytest.mark.parametrize(
    "move_history, expected",
    [
        # opening_moves_for_white
        (
            "",
...
def test_possible_requested_moves(move_history: str, expected: str):
    board = chess.Board()
